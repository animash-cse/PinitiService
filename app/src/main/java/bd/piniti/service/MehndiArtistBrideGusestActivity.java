...
public class MehndiArtistBrideGusestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mehndi_artist_bride_gusest);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MehndiArtistBrideGusestActivity.this,MehndiArtistBrideGuestThreeActivity.class);
        ...
        RecyclerView.LayoutManager layoutManager1 = new LinearLayoutManager(MehndiArtistBrideGusestActivity.this);
        ...
        Adapter = new MehndiArtistOneRecycleAdapter(MehndiArtistBrideGusestActivity.this,mehndiArtistOneModelClasses);
