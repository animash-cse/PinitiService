...
public class ToiletSanitaryWorkSixActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_toilet_sanitary_work_six);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ToiletSanitaryWorkSixActivity.this,ToiletSanitaryWorkSevenActivity.class);
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(ToiletSanitaryWorkSixActivity.this);
        ...
        bAdapter = new DateDayRecycleAdapter(ToiletSanitaryWorkSixActivity.this,dateDayModelClasses);
        ...
        RecyclerView.LayoutManager layoutManager1 = new GridLayoutManager(ToiletSanitaryWorkSixActivity.this,3);
        ...
        bAdapter1 = new TimeRecycleAdapter(ToiletSanitaryWorkSixActivity.this,dateDayModelClasses1);
        ...
        RecyclerView.LayoutManager layoutManager2 = new GridLayoutManager(ToiletSanitaryWorkSixActivity.this,3);
        ...
        bAdapter2 = new TimeRecycleAdapter(ToiletSanitaryWorkSixActivity.this,dateDayModelClasses2);
        ...
        RecyclerView.LayoutManager layoutManager3 = new GridLayoutManager(ToiletSanitaryWorkSixActivity.this,3);
        ...
        bAdapter3 = new TimeRecycleAdapter(ToiletSanitaryWorkSixActivity.this,dateDayModelClasses3);
