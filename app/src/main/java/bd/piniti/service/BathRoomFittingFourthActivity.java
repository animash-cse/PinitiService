...
public class BathRoomFittingFourthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bath_room_fitting_fourth);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BathRoomFittingFourthActivity.this,BathRoomFittingFifthActivity.class);
