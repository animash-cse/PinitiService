...
public class BlocksLeakageSecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_blocks_leakage_second);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BlocksLeakageSecondActivity.this,BlocksLeakageThirdActivity.class);
