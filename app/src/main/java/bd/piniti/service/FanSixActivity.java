...
public class FanSixActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fan_six);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FanSixActivity.this,FanSevenActivity.class);
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(FanSixActivity.this);
        ...
        bAdapter = new DateDayRecycleAdapter(FanSixActivity.this,dateDayModelClasses);
        ...
        RecyclerView.LayoutManager layoutManager1 = new GridLayoutManager(FanSixActivity.this,3);
        ...
        bAdapter1 = new TimeRecycleAdapter(FanSixActivity.this,dateDayModelClasses1);
        ...
        RecyclerView.LayoutManager layoutManager2 = new GridLayoutManager(FanSixActivity.this,3);
        ...
        bAdapter2 = new TimeRecycleAdapter(FanSixActivity.this,dateDayModelClasses2);
        ...
        RecyclerView.LayoutManager layoutManager3 = new GridLayoutManager(FanSixActivity.this,3);
        ...
        bAdapter3 = new TimeRecycleAdapter(FanSixActivity.this,dateDayModelClasses3);
