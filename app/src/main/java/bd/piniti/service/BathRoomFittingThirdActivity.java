...
public class BathRoomFittingThirdActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bath_room_fitting_third);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BathRoomFittingThirdActivity.this,BathRoomFittingFourthActivity.class);
