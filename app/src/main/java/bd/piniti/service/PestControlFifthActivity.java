...
public class PestControlFifthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pest_control_fifth);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(PestControlFifthActivity.this,PestControlSixActivity.class);
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(PestControlFifthActivity.this);
        ...
        bAdapter = new DateDayRecycleAdapter(PestControlFifthActivity.this,dateDayModelClasses);
        ...
        RecyclerView.LayoutManager layoutManager1 = new GridLayoutManager(PestControlFifthActivity.this,3);
        ...
        bAdapter1 = new TimeRecycleAdapter(PestControlFifthActivity.this,dateDayModelClasses1);
        ...
        RecyclerView.LayoutManager layoutManager2 = new GridLayoutManager(PestControlFifthActivity.this,3);
        ...
        bAdapter2 = new TimeRecycleAdapter(PestControlFifthActivity.this,dateDayModelClasses2);
        ...
        RecyclerView.LayoutManager layoutManager3 = new GridLayoutManager(PestControlFifthActivity.this,3);
        ...
        bAdapter3 = new TimeRecycleAdapter(PestControlFifthActivity.this,dateDayModelClasses3);
