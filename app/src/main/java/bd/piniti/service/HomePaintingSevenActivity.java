...
public class HomePaintingSevenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_painting_seven);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HomePaintingSevenActivity.this,HomePaintingEightActivity.class);
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(HomePaintingSevenActivity.this);
        ...
        bAdapter = new DateDayRecycleAdapter(HomePaintingSevenActivity.this,dateDayModelClasses);
        ...
        RecyclerView.LayoutManager layoutManager1 = new GridLayoutManager(HomePaintingSevenActivity.this,3);
        ...
        bAdapter1 = new TimeRecycleAdapter(HomePaintingSevenActivity.this,dateDayModelClasses1);
        ...
        RecyclerView.LayoutManager layoutManager2 = new GridLayoutManager(HomePaintingSevenActivity.this,3);
        ...
        bAdapter2 = new TimeRecycleAdapter(HomePaintingSevenActivity.this,dateDayModelClasses2);
        ...
        RecyclerView.LayoutManager layoutManager3 = new GridLayoutManager(HomePaintingSevenActivity.this,3);
        ...
        bAdapter3 = new TimeRecycleAdapter(HomePaintingSevenActivity.this,dateDayModelClasses3);
