...
public class PartyDecorationFifthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_party_decoration_fifth);
        ...
        title.setText("Party Decoration");
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PartyDecorationFifthActivity.this,PartyDecorationSixActivity.class);
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(PartyDecorationFifthActivity.this);
        ...
        bAdapter = new DateDayRecycleAdapter(PartyDecorationFifthActivity.this,dateDayModelClasses);
        ...
        RecyclerView.LayoutManager layoutManager1 = new GridLayoutManager(PartyDecorationFifthActivity.this,3);
        ...
        bAdapter1 = new TimeRecycleAdapter(PartyDecorationFifthActivity.this,dateDayModelClasses1);
        ...
        RecyclerView.LayoutManager layoutManager2 = new GridLayoutManager(PartyDecorationFifthActivity.this,3);
        ...
        bAdapter2 = new TimeRecycleAdapter(PartyDecorationFifthActivity.this,dateDayModelClasses2);
        ...
        RecyclerView.LayoutManager layoutManager3 = new GridLayoutManager(PartyDecorationFifthActivity.this,3);
        ...
        bAdapter3 = new TimeRecycleAdapter(PartyDecorationFifthActivity.this,dateDayModelClasses3);
