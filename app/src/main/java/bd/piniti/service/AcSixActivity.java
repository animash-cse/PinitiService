...
public class AcSixActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AcSixActivity.this,AcSevenPaymentActivity.class);
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(AcSixActivity.this);
        ...
        bAdapter = new DateDayRecycleAdapter(AcSixActivity.this,dateDayModelClasses);
        ...
        RecyclerView.LayoutManager layoutManager1 = new GridLayoutManager(AcSixActivity.this,3);
        ...
        bAdapter1 = new TimeRecycleAdapter(AcSixActivity.this,dateDayModelClasses1);
        ...
        RecyclerView.LayoutManager layoutManager2 = new GridLayoutManager(AcSixActivity.this,3);
        ...
        bAdapter2 = new TimeRecycleAdapter(AcSixActivity.this,dateDayModelClasses2);
        ...
        RecyclerView.LayoutManager layoutManager3 = new GridLayoutManager(AcSixActivity.this,3);
        ...
        bAdapter3 = new TimeRecycleAdapter(AcSixActivity.this,dateDayModelClasses3);
