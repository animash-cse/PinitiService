...
public class MehndiArtistBrideActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mehndi_artist_bride);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MehndiArtistBrideActivity.this,MehndiArtistBrideGusestActivity.class);
        ...
        RecyclerView.LayoutManager layoutManager1 = new LinearLayoutManager(MehndiArtistBrideActivity.this);
        ...
        Adapter = new MehndiArtistOneRecycleAdapter(MehndiArtistBrideActivity.this,mehndiArtistOneModelClasses);
