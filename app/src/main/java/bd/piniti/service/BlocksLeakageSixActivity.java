...
public class BlocksLeakageSixActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_blocks_leakage_six);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BlocksLeakageSixActivity.this,BlocksLeakageSevenActivity.class);
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(BlocksLeakageSixActivity.this);
        ...
        bAdapter = new DateDayRecycleAdapter(BlocksLeakageSixActivity.this,dateDayModelClasses);
        ...
        RecyclerView.LayoutManager layoutManager1 = new GridLayoutManager(BlocksLeakageSixActivity.this,3);
        ...
        bAdapter1 = new TimeRecycleAdapter(BlocksLeakageSixActivity.this,dateDayModelClasses1);
        ...
        RecyclerView.LayoutManager layoutManager2 = new GridLayoutManager(BlocksLeakageSixActivity.this,3);
        ...
        bAdapter2 = new TimeRecycleAdapter(BlocksLeakageSixActivity.this,dateDayModelClasses2);
        ...
        RecyclerView.LayoutManager layoutManager3 = new GridLayoutManager(BlocksLeakageSixActivity.this,3);
        ...
        bAdapter3 = new TimeRecycleAdapter(BlocksLeakageSixActivity.this,dateDayModelClasses3);
