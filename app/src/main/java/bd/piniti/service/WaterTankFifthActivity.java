...
public class WaterTankFifthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_water_tank_fifth);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WaterTankFifthActivity.this,WaterTankSixActivity.class);
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(WaterTankFifthActivity.this);
        ...
        bAdapter = new DateDayRecycleAdapter(WaterTankFifthActivity.this,dateDayModelClasses);
        ...
        RecyclerView.LayoutManager layoutManager1 = new GridLayoutManager(WaterTankFifthActivity.this,3);
        ...
        bAdapter1 = new TimeRecycleAdapter(WaterTankFifthActivity.this,dateDayModelClasses1);
        ...
        RecyclerView.LayoutManager layoutManager2 = new GridLayoutManager(WaterTankFifthActivity.this,3);
        ...
        bAdapter2 = new TimeRecycleAdapter(WaterTankFifthActivity.this,dateDayModelClasses2);
        ...
        RecyclerView.LayoutManager layoutManager3 = new GridLayoutManager(WaterTankFifthActivity.this,3);
        ...
        bAdapter3 = new TimeRecycleAdapter(WaterTankFifthActivity.this,dateDayModelClasses3);
