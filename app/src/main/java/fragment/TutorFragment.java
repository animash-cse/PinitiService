...
import Adapter.TutorRecycleAdapter;
...
public class TutorFragment extends Fragment {
    ...
    private TutorRecycleAdapter bAdapter;


    private  Integer image[] = {R.drawable.home_painting,R.drawable.office_painting};
    private String title[] = {"Admission","Test Prep"};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bAdapter = new TutorRecycleAdapter(getActivity(),homeCategoryModelClasses);
