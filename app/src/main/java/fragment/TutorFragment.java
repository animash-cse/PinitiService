...
public class TutorFragment extends Fragment {
    ...
    private ArrayList<Team> getData() {
        ...
        Team t1 = new Team("Math Teacher");
        t1.players.add("Class 12");
        t1.players.add("Class 11");
        t1.players.add("Class 10");
        t1.players.add("Class 9");
        t1.players.add("Class 8");
        t1.players.add("Class 7");
        t1.players.add("Class 6");
        t1.players.add("Class 5");

        Team t2 = new Team("Science Teacher");
        t2.players.add("Class 12");
        t2.players.add("Class 11");
        t2.players.add("Class 10");
        t2.players.add("Class 9");
        t2.players.add("Class 8");
        t2.players.add("Class 7");
        t2.players.add("Class 6");
        t2.players.add("Class 5");
