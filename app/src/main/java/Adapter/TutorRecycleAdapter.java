...
public class TutorRecycleAdapter extends RecyclerView.Adapter<TutorRecycleAdapter.MyViewHolder> {
    ...
    public TutorRecycleAdapter(Context context, List<HomeCategoryModelClass> offerList) {
        this.OfferList = offerList;
        this.context = context;
    }

    @Override
    public TutorRecycleAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_appliance_repair_list, parent, false);


        return new TutorRecycleAdapter.MyViewHolder(itemView);
