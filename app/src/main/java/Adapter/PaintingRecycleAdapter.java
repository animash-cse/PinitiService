...
public class PaintingRecycleAdapter extends RecyclerView.Adapter<PaintingRecycleAdapter.MyViewHolder> {
    ...
    public PaintingRecycleAdapter(Context context, List<HomeCategoryModelClass> offerList) {
        this.OfferList = offerList;
        this.context = context;
    }

    @Override
    public PaintingRecycleAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_appliance_repair_list, parent, false);


        return new PaintingRecycleAdapter.MyViewHolder(itemView);
